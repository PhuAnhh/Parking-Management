    ...
    namespace Parking_Management.Parking.Persistence.DbContexts;
    ...
    public partial class ParkingManagementContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__permissi__3213E83FE2786FE8");
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__roles__3213E83F3E337A24");
            ...
            {
                entity.HasKey(e => new { e.RoleId, e.PermissionId }).HasName("PK__role_per__C85A54639F7AD7BD");
                ...
                entity.HasOne(d => d.Permission).WithMany(p => p.RolePermissions)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__role_perm__permi__719CDDE7");

                entity.HasOne(d => d.Role).WithMany(p => p.RolePermissions)
                    .HasForeignKey(d => d.RoleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__role_perm__role___70A8B9AE");
            });

            modelBuilder.Entity<User>(entity =>
            {
                entity.HasKey(e => e.Id).HasName("PK__users__3213E83F3F5CAEB8");
            ...
            {
                entity.HasKey(e => new { e.UserId, e.RoleId }).HasName("PK__user_rol__6EDEA153CD870A9B");
                ...
                entity.HasOne(d => d.Role).WithMany(p => p.UserRoles)
                    .HasForeignKey(d => d.RoleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_role__role___681373AD");

                entity.HasOne(d => d.User).WithMany(p => p.UserRoles)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_role__user___671F4F74");
            });
